...
Infinite.prototype.Constant_ = {
    ...
    __templateArray: ["\u003Ca href=/a/",
        "1:{{admin.id}}",
        "\u003E\u003Cdiv class=medium-list__image\u003E\u003Cdiv class=medium-list__image-s style=background-image:url(/resource/",
        "3:{{admin.image}}",
        ")\u003E\u003C/div\u003E\u003C/div\u003E\u003Cdiv class=medium-list__footer\u003E\u003Cdiv class=\u0022medium-list__footer-container mobile-flex-vc\u0022\u003E\u003Cdiv class=\u0022medium-list__title line-clamp--2\u0022\u003E\u003Cspan\u003E",
        "5:{{admin.title}}",
        "\u003C/span\u003E\u003C/div\u003E\u003C/div\u003E\u003C/div\u003E\u003C/a\u003E"],
    __distance: 10
}
...
Infinite.prototype.prepare = function () {
    ...
    this._url = window.location.pathname === "/" ? "/api/list/" : "/api/lt?tag=" + window.location.pathname.split('/')[window.location.pathname.split('/').length - 1] + "&skip="
...
Infinite.prototype.append = function (obj) {
    for (var index = 0; index < obj.length; index++) {
        ...
        this.Constant_.__templateArray[3] = element["image"];
        this.Constant_.__templateArray[5] = element["title"];
...
Infinite.prototype.handleScroll = function () {
    ...
    var clientHeight = Math.max(document.documentElement.clientHeight, window.innerHeight);
